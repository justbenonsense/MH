...
// NOTA: compilar g++ -g AGEuniforme.cpp -o AGEuniforme
//       ejecutar ./AGEuniforme archivo.txt semilla
/////////////////////////////////////////////////////////////////
...
/*****************************************************************/
void AGEuniforme(int m, poblacion & pActual, vector<vector<float> > & matriz){
    ...
    do {
        ...
        cruceUniforme(m,0,pPadres,matriz);
...
int main(int argc, char *argv[]){
    ...
    AGEuniforme(m,pActual,matriz_distancias);
