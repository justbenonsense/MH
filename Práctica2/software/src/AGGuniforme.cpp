...
// NOTA: compilar g++ -g AGGuniforme.cpp -o AGGuniforme
//       ejecutar ./AGGuniforme archivo.txt semilla
/////////////////////////////////////////////////////////////////
...
/*****************************************************************/
// Función para reparar un hijo después del cruce
/*****************************************************************/
...
/*****************************************************************/
void AGGuniforme(int m, poblacion & pActual, vector<vector<float> > & matriz){
...
int main(int argc, char *argv[]){
    ...
    AGGuniforme(m,pActual,matriz_distancias);
