...
// NOTA: compilar g++ -g AGGposicion.cpp -o AGGposicion
//       ejecutar ./AGGposicion archivo.txt semilla
/////////////////////////////////////////////////////////////////
...
struct poblacion {
    ...
    int mejorSol;                 // Índice de la mejor solución (cromosoma)
...
void solucionAletoria(int m, solucion & s, vector<vector<float> > & matriz){
    ...
    while (cont < m){
        ...
        // Si no lo hemos seleccionado el gen todavía
...
void crucePosicion(int pos, poblacion & pPadres){
    ...
    // Aleatorizamos los restos del padre1
...
/*****************************************************************/
void AGGposicion(int m, poblacion & pActual, vector<vector<float> > & matriz){
    ...
    // Creamos una población de padres con el mismo tamaño que pActual
    poblacion pPadres;
    ...
    do {
        ...
        // Procedemos a actualizar las contribuciones
...
int main(int argc, char *argv[]){
    ...
    AGGposicion(m,pActual,matriz_distancias);
