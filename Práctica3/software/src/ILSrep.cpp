...
// NOTA: compilar g++ -g ILSrep.cpp -o ILSrep                   //
//       ejecutar ./ILSrep archivo.txt semilla                  //
//////////////////////////////////////////////////////////////////
...
/*****************************************************************/
void mutacion(solucion & sol, vector<vector<float> > & matriz){
    ...
    int aleatorio1 = rand() % sol.Sel.size();

    // Elegimos aleatoriamente un elemento sin seleccionar
    int aleatorio2 = rand() % (sol.S.size());
    ...
    // Calculamos la diferencia con la mejora
    mejoraIntercambio(diferencia,aleatorio1,elem_in.first,sol.Sel,matriz);
